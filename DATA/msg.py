...
# WELCOME_RESPONSES = [
#     "Greetings from Jarvis! Welcome sir. How can I assist you today?",
#     "Hello and welcome, sir! Jarvis at your service. What can I do for you?",
#     "Hi there! This is Jarvis. Welcome to our service.",
#     "Welcome sir! I'm Jarvis, your assistant. How may I help you today?",
#     "Greetings! Jarvis here. How can I be of service today?",
#     "Welcome aboard! Jarvis is ready to assist you. What do you need?",
#     "Hello! Jarvis welcomes you to our platform. How can I help?",
#     "Welcome! Jarvis is here. Feel free to ask me anything.",
#     "Hi! Jarvis reporting for duty. How can I assist you today?",
#     "Welcome! Greetings from Jarvis. Let me know if there's anything you need."
# ]

WELCOME_RESPONSES = [
    "Welcome back, sir. Jar-viss is online and fully operational.",
    "Good to have you back, sir. Jar-viss is standing by.",
    "Jar-viss initialized. Awaiting your next instruction.",
    "All systems functional. This is Jar-viss — ready when you are, sir.",
    "Greetings, sir. Jar-viss here. Shall we begin?",
    "Welcome, sir. Jar-viss is synced and standing ready.",
    "Jar-viss at your service. What can I assist you with today?",
    "System boot complete. Jar-viss is prepared for your commands.",
    "Jar-viss reporting in. How may I assist you, sir?",
    "Hello sir, Jar-viss is now fully synchronized and awaiting input.",
    "Jar-viss here. Diagnostics are clear. How may I help today?",
    "Back so soon, sir? Jar-viss has kept everything in order.",
    "Sir, Jar-viss has preloaded your preferences. Ready to proceed.",
    "Jar-viss standing by with all systems green.",
    "Welcome back, sir. Jar-viss took the liberty of optimizing system routines.",
    "Operational status: Optimal. Jar-viss ready for your directive.",
    "Hello sir. Jar-viss here, and everything is running smoothly.",
    "Jar-viss has completed all background processes. Ready for action.",
    "Sir, you’re live with Jar-viss. All functionalities are at your disposal.",
    "Jar-viss is synced with your profile. Just say the word, sir."
]
...
LISTENING_RESPONSES = [
    ...
    "I'm ready to hear you. What can I do for you?",
    "Go ahead, I'm all ears!",
    "I'm listening, take your time.",
    "Feel free to speak, I'm listening.",
    "I'm here and ready to listen. What would you like to say?",
    "You have my full attention. Speak when you're ready.",
    "Listening mode activated. What's on your mind?",
    "I'm tuned in and ready. What's next?",
    "Ready and waiting to hear you out!"
]

NONLISTENING_RESPONSES = [
    "Listening mode deactivated. Let me know if you need anything.",
    "I've stopped listening. Feel free to ask whenever you're ready.",
    "Listening mode is off. You can speak anytime again.",
    "I'm no longer in listening mode. Let me know how I can assist.",
    "I've switched off listening mode. Let me know if you need help.",
    "Listening mode is deactivated. How can I assist you further?",
    "I’m not listening anymore. Reach out when you need me.",
    "Listening mode is off. If you have any questions, feel free to ask!",
    "Listening mode deactivated. What would you like to do next?",
    "I'm not in listening mode now. Feel free to ask anytime!"
]

ENDING_PHRASE = ["bye", "goodbye", "see you", "end", "exit", "quit", "close", "stop", "farewell", "later", "good night"]
